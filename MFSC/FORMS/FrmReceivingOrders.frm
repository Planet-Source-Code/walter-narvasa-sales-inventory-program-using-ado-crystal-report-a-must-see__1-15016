...
Begin VB.Form fReceivingOrders 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Receiving Orders Transaction"
   ClientHeight    =   6315
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   8910
   Icon            =   "FrmReceivingOrders.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "FrmReceivingOrders.frx":0442
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   300
         Left            =   120
         MouseIcon       =   "FrmReceivingOrders.frx":045E
         MousePointer    =   99  'Custom
         Picture         =   "FrmReceivingOrders.frx":0768
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   5400
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   300
         Left            =   480
         MouseIcon       =   "FrmReceivingOrders.frx":0AAA
         MousePointer    =   99  'Custom
         Picture         =   "FrmReceivingOrders.frx":0DB4
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   5400
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   300
         Left            =   8055
         MouseIcon       =   "FrmReceivingOrders.frx":10F6
         MousePointer    =   99  'Custom
         Picture         =   "FrmReceivingOrders.frx":1400
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   5400
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   300
         Left            =   8400
         MouseIcon       =   "FrmReceivingOrders.frx":1742
         MousePointer    =   99  'Custom
         Picture         =   "FrmReceivingOrders.frx":1A4C
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   5400
         UseMaskColor    =   -1  'True
      ...
      Begin VB.Frame Frame1 
         ...
         Begin VB.TextBox txtFields 
            DataField       =   "ReceivingOrder_ReceivedBy"
            Enabled         =   0   'False
            Height          =   285
            Index           =   4
            Left            =   4920
         ...
         End
         Begin VB.TextBox txtFields 
            DataField       =   "ReceivingOrder_PO_Date"
         ...
         Begin VB.TextBox txtFields 
            ...
            DataField       =   "ReceivingOrder_GTotals"
            BeginProperty DataFormat 
               Type            =   1
               Format          =   "#,##0.00"
               HaveTrueFalseNull=   0
         ...
         Begin VB.Frame Frame2 
            Caption         =   "Receiving Orders Ingredients Details:"
            BeginProperty Font 
               Name            =   "MS Sans Serif"
               Size            =   8.25
               Charset         =   0
            ...
            Begin VB.ListBox cboSearchIngredient 
               DragIcon        =   "FrmReceivingOrders.frx":1D8E
               Height          =   1425
               Left            =   240
               Sorted          =   -1  'True
               TabIndex        =   23
            ...
            Begin VB.ListBox lstSearchIngredient 
               DragIcon        =   "FrmReceivingOrders.frx":21D0
               Height          =   1425
               Left            =   2280
               Sorted          =   -1  'True
               TabIndex        =   22
         ...
         Begin VB.ComboBox txtCombo 
            DataField       =   "ReceivingOrder_PO_Number"
            Enabled         =   0   'False
            Height          =   315
            Left            =   1680
            TabIndex        =   2
         ...
         End
         Begin VB.TextBox txtFields 
            DataField       =   "ReceivingOrder_DR_Date"
            BeginProperty DataFormat 
               Type            =   1
               Format          =   "MM/dd/yyyy"
               HaveTrueFalseNull=   0
         ...
         End
         Begin VB.TextBox txtFields 
            DataField       =   "ReceivingOrder_DR_Number"
            Enabled         =   0   'False
            Height          =   285
            Index           =   0
            Left            =   1680
   ...
   End
End
Attribute VB_Name = "fReceivingOrders"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' MODULE/FORM: RECEIVING ORDERS TRANSACTION
' VERSION: VB6

' RECEIVING ORDERS VARIABLE SETTINGS
Dim strDB As String
...
Private Sub Form_Load()
    ' STARTUP RECEIVING ORDERS TRANSACTION DATABASE CONNECTIONS/SETTINGS
    blnListShow = False
    strDB = App.Path + "\DATABASE\MFSC.MDB;Jet OLEDB:Database Password=MFSC;"
    strSQL = "SHAPE {SELECT ReceivingOrder_DR_Number,ReceivingOrder_DR_Date,ReceivingOrder_PO_Number,ReceivingOrder_PO_Date,ReceivingOrder_GTotals,ReceivingOrder_ReceivedBy,ReceivingOrder_Posted FROM [ReceivingOrders_Header] ORDER BY ReceivingOrder_DR_Number} AS ParentCMD" & _
             " APPEND ({SELECT ReceivingOrder_DR_Number,ReceivingOrder_Ingredient_Code,ReceivingOrder_Ingredient_Name,ReceivingOrder_Ingredient_Costs,ReceivingOrder_QtyReceived,ReceivingOrder_STotalCosts FROM [ReceivingOrders_Detail] ORDER BY ReceivingOrder_Ingredient_Code } AS ChildCMD" & _
             " RELATE ReceivingOrder_DR_Number TO ReceivingOrder_DR_Number) AS ChildCMD"
    Database_Refresh 0
    ...
    Else
        xGridLogic = True
    End If
    strSQL7 = "SELECT PurchaseOrder_Number FROM PurchaseOrders_Header ORDER BY PurchaseOrder_Number"
    Database_Refresh 6
    If adoPrimaryRS7.RecordCount <> 0 Then
        adoPrimaryRS7.MoveFirst
        Do While Not adoPrimaryRS7.EOF
            txtCombo.AddItem IIf(IsNull(adoPrimaryRS7("PurchaseOrder_Number")), "", adoPrimaryRS7("PurchaseOrder_Number"))
...
Public Sub cmdEdit_Click()
    ...
    If Rights1_Edit = 1 Then
        If adoPrimaryRS.RecordCount <> 0 Then
            xCode = InputBox("Please Enter DR Number:", "Receiving Orders Transaction - Edit Mode")
            If xCode <> "" Then
                adoPrimaryRS.MoveFirst
                Do While adoPrimaryRS.Fields("ReceivingOrder_DR_Number") <> Trim(xCode)
                    adoPrimaryRS.MoveNext
                Loop
                If adoPrimaryRS("ReceivingOrder_Posted") = True Then
                    MsgBox "DR Number is already posted!!", vbOKOnly + vbCritical, "Warning:End-User:" + UserName
                Else
                    mbEditFlag = True
                    SetButtons False
                    grdDetails.Enabled = True
    ...
    Exit Sub
EditErr:
  MsgBox "DR Number does not exist!!", vbOKOnly + vbCritical, " Warning:End-User"
End Sub
...
Public Sub cmdUpdate_Click()
    ...
    If txtFields(0) = "" Then
        ActiveBlankFields = ActiveBlankFields + "DR Number"
    Else
        ActiveBlankFields = ""
    End If
    If txtFields(1) = "" Then
        If txtFields(0) = "" Then
            ActiveBlankFields = ActiveBlankFields + ",DR Date"
        Else
            ActiveBlankFields = ActiveBlankFields + "DR Date"
        End If
    Else
    ...
    If txtFields(4) = "" Then
        If txtFields(2) = "" Then
            ActiveBlankFields = ActiveBlankFields + ",Received by"
        Else
            ActiveBlankFields = ActiveBlankFields + "Received by"
        End If
    Else
...
Public Sub txtFields_LostFocus(Index As Integer)
    ...
    If Index = 0 Then
        If Get_DR_Number Then
                Msg = MsgBox("DR Number already exist!!", vbOKOnly + vbCritical, "Warning:End-User:" + UserName)
                txtFields(0) = ""
                txtFields(0).SetFocus
        ElseIf txtFields(0) = "" Then
                Msg = MsgBox("DR Number cannot be empty!!", vbOKOnly + vbCritical, "Warning:End-User:" + UserName)
                cmdCancel_Click
        End If
    End If
    Exit Sub
...
Function Get_DR_Number() As Boolean
    ' DR NUMBER VALIDATION ON txtFields(0) TEXTBOX
    On Error Resume Next
    strSQL2 = "SELECT * FROM [ReceivingOrders_Header] WHERE ReceivingOrder_DR_Number = '" & txtFields(0) & "'"
    Database_Refresh 1
...
Public Sub Ingredient_Not_found()
    ...
    Msg = MsgBox("Ingredient Code not found!!" & vbCrLf & "Do you want add this" & vbCrLf & _
        ...
        If Msg = vbYes Then
            ...
            OrderEntryModule = "fReceivingOrders"
        End If
End Sub
...
Public Sub Recalculate_Grand_Totals()
    ...
    On Error Resume Next
    If adoPrimaryRS.RecordCount <> 0 Then
        strSQL4 = "SELECT SUM(ReceivingOrder_STotalCosts) FROM [ReceivingOrders_Detail] WHERE ReceivingOrder_DR_Number = '" & adoPrimaryRS("ReceivingOrder_DR_Number") & "'"
        Database_Refresh 3
        txtFields(3) = IIf(IsNull(adoPrimaryRS4(0)), 0#, Format(adoPrimaryRS4(0), "###,###,###.00"))
    End If
End Sub
